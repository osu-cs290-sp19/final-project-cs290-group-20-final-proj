...
function save(event){
    ...
    for(var i=0;i<tables.length-1;i++) {
        ...
        schedule[i]=
        {
            ...
            slots:[
                {class:inputText[0+15*i].value,location:inputText[1+15*i].value,time:inputText[2+15*i].value},
                {class:inputText[3+15*i].value, location:inputText[4+15*i].value , time:inputText[5+15*i].value},
                {class:inputText[6+15*i].value, location:inputText[7+15*i].value , time:inputText[8+15*i].value},
                {class:inputText[9+15*i].value, location:inputText[10+15*i].value , time:inputText[11+15*i].value},
                {class:inputText[12+15*i].value, location:inputText[13+15*i].value , time:inputText[14+15*i].value}
            ]
        }
        //debugger;
        schedule.push(schedule[i]);
        table={schedule};
    } 
